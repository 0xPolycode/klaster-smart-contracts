...
// File contracts/MaliciousPaymaster.test.sol

contract MaliciousPaymaster is BasePaymaster {
    constructor(IEntryPoint entryPoint) payable BasePaymaster(entryPoint) {}
    ...
    function _postOp(PostOpMode mode, bytes calldata context, uint256 actualGasCost) internal virtual override {
        // do nothing on _postOp , avoid refunding the user (malicious paymaster)
    }
}
